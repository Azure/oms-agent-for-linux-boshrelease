...
```
# BOSH CLI v1
bosh upload release https://github.com/Azure/oms-agent-for-linux-boshrelease/releases/download/v1.12.7-0/oms-agent-for-linux-1.12.7-0.tgz

# BOSH CLI v2
bosh2 upload-release https://github.com/Azure/oms-agent-for-linux-boshrelease/releases/download/v1.12.7-0/oms-agent-for-linux-1.12.7-0.tgz
```
